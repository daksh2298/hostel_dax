...
include '../../dbh.php';
	...
	$table_f_obc="<br><table id='f_obc' cellspacing='0px' cellpadding='10px' border='3px'> 
	<caption>FEMALE OBC</caption>
	<tr>
		<th>SR NO</th>		
		<th>MERIT RANK</th>		
		<th>NAME </th>
	...
	$m_gen_fetch="SELECT * FROM merit_sort WHERE Gender='female' AND Quota='obc';";
	//$q="select * from book ";
